...
public class CategoriesAdapter extends RecyclerView.Adapter<CategoriesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoriesAdapter.ViewHolder holder, int position) {
        ...
        if (null != categories.getHinhanh() && !TextUtils.isEmpty(categories.getHinhanh())) {
            holder.ivPhanLoaiPicture.setImageResource(context.getResources().getIdentifier(
                    categories.getHinhanh(), "drawable", "com.example.doan"));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        TextView tvidloai, tvnameloai, tvmota, hinh;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            hinh = itemView.findViewById(R.id.url);
