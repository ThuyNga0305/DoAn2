...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.anh_MA.setImageResource(context.getResources().getIdentifier(
                list.get(position).getHinhAnhMonAn(), "drawable", "com.example.doan"));

//        Glide.with(context)
//                .load(list.get(position).getHinhAnhMonAn())
//                .into(holder.anh_MA);
